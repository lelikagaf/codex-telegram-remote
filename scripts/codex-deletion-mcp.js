...
function localTool() {
  return {
    ...
    description: [
      ...
      "Respect policy and permission denials; this tool must not be used to bypass them.",
      ...
      if (message.method === "initialize") {
        write({
          ...
          result: {
            ...
            instructions: "Use these deletion tools only after an explicit deletion request from the Telegram owner. Pass exact paths, never globs. Respect policy and permission denials; never bypass them with another tool.",
          },
        });
        return;
      }
